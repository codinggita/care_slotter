  ...
  return (
    <div className="relative flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 overflow-hidden">
      ...
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px] relative z-10">
        ...
        <a
          href="#speciality"
          className="flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
        >
      ...
      <div className="md:w-1/2 relative z-10">
        <img className="w-full md:absolute bottom-0 h-auto rounded-lg shadow-lg" src={assets.header_img} alt="Header Image" />
      </div>
    </div>
  );
};
